...
function peg$parse(input, options) {
  ...
  var peg$e8 = peg$classExpectation(["\t", "\v", "\f", " "], false, false);
  var peg$e9 = peg$otherExpectation("end of line");
  var peg$e10 = peg$classExpectation(["\n", "\r"], false, false);

  var peg$f0 = function(type, subtype, params) {
  ...
  function peg$parsestart() {
    ...
    s0 = peg$currPos;
    s1 = [];
    s2 = peg$parsemediaRange();
    while (s2 !== peg$FAILED) {
      s1.push(s2);
      s2 = peg$currPos;
      s3 = peg$parsemediaRangeDelimiter();
      if (s3 !== peg$FAILED) {
        s3 = peg$parsemediaRange();
        if (s3 === peg$FAILED) {
          peg$currPos = s2;
          s2 = peg$FAILED;
        } else {
    ...
    s2 = peg$parsemediaRangeDelimiter();
    if (s2 === peg$FAILED) {
      s2 = null;
    }
    s1 = [s1, s2];
  ...
  function peg$parsemediaRangeDelimiter() {
    var s0, s1, s2, s3;
